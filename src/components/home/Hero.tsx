  ...
  return (
    <section className="w-full bg-text text-white pt-24 pb-24 lg:pt-32 lg:pb-36 overflow-hidden relative font-['Poppins',sans-serif]">
      ...
      <div className="absolute inset-0 opacity-[0.02] flex items-center justify-center pointer-events-none">
        <Heart className="w-[600px] h-[600px] stroke-[1]" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center text-left space-y-8">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight leading-[1.1] text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-slate-400">
              Mais que um seguro, um compromisso com o que{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF7A38] to-[#ff9866]">
                realmente importa.
              </span>
            </h1>
          ...
          <div className="lg:col-span-6 flex justify-center relative mt-8 lg:mt-0">
            ...
            <div className="relative w-full max-w-[540px] aspect-[4/5] sm:aspect-[4/4.5] rounded-[40px] overflow-hidden shadow-[0_24px_60px_rgba(0,0,0,0.5)] border border-white/5 bg-slate-900 group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#0B0F19]/60 via-transparent to-transparent z-10" />
              <div className="absolute inset-0 bg-slate-950/10 z-10 mix-blend-multiply" />
              
            </div>

            {/* Elemento decorativo flutuante geométrico de fundo */}
            <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-gradient-to-br from-[#FF7A38]/20 to-transparent rounded-full blur-2xl -z-10" />
